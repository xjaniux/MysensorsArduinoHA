...
const RelayConfigDef gRelayConfig[] PROGMEM = {
  {1, 2, RELAY_TRIGGER_LOW, -1, "Sypialnia Łóżko"}, //12(23) Ośw. Sypialnia nad łóżkiem
  {2, 3, RELAY_TRIGGER_LOW, -1, "Sypialnia TV"}, //7(22) Ośw. Sypialnia nad TV Spot.5
  {3, 4, RELAY_TRIGGER_LOW, -1, "Garderoba Syp"},  //13(24) Ośw. Garderoba przy sypialni
  {4, 5, RELAY_TRIGGER_LOW, -1, "Ana Łóżko"},  //10(21) Ośw. Ana nad łóżkiem
  {5, 6, RELAY_TRIGGER_LOW, -1, "Ana Biurko"},   //11(20) Ośw. Ana nad biurkiem Spot.3
  {6, 7, RELAY_TRIGGER_LOW, -1, "Mati Biurko"},  //15(17) Ośw. Mati nad biurkiem 3x
  {7, 8, RELAY_TRIGGER_LOW, -1, "Mati Łóżko"},  //14(16) Ośw. Mati nad łóżkiem Spot.3
  {8, 9, RELAY_TRIGGER_LOW, -1, "Łazienka Duża"},  //17(19) Ośw. Łazienka duża
  {9, 10, RELAY_TRIGGER_LOW, -1, "Łazienka Wanna"},  //16(18) Ośw. Łazienka duża nad wanną 2x
  {10, 11, RELAY_TRIGGER_LOW, -1, "Hal Korytarz"},  //59(10) Ośw. Hal Korytarz Spot.7
  {11, 12, RELAY_TRIGGER_LOW, -1, "Led Hal"},  //55-57(LedHal) Ośw. Led Hal 
  {12, 13, RELAY_TRIGGER_LOW, -1, "Salon 1"},  //62(8) Ośw. Salon nad kanapą 
  {13, 14, RELAY_TRIGGER_LOW, -1, "Salon 2"},  //63(9) Ośw. Salon nad TV 
  {14, 15, RELAY_TRIGGER_LOW, -1, "Salon Kinkiety"},  //58(C11) Ośw. Salon kinkiety 4x
  {15, 16, RELAY_TRIGGER_LOW, -1, "Jadalnia Stół"},  //65(6) Ośw. Jadalnia nad stołem
  {16, 17, RELAY_TRIGGER_LOW, -1, "Jadalnia Hal"}, //64(3) Ośw. Jadalnia Hal Spot.6
  {17, 18, RELAY_TRIGGER_LOW, -1, "Jadalnia Piano"},  //67(2) Ośw. Jadalnia Pianino Spot.5
  {18, 19, RELAY_TRIGGER_LOW, -1, "Kuchnia"},  //66(4) Ośw. Kuchnia Spot.6
  {19, 20, RELAY_TRIGGER_LOW, -1, "Kuchnia Stolik"},  //69(7) Ośw. Kuchnia nad stolikiem 3x
  {20, 23, RELAY_TRIGGER_LOW, -1, "Spiżarnia"},  //68(5) Ośw. Spiżarnia
  {21, 24, RELAY_TRIGGER_LOW, -1, "Łazienka Mała"},  //8(29) Ośw. Łazienka mała Spot.3
  {22, 25, RELAY_TRIGGER_LOW, -1, "Wiatrołap"}, //60(1) Ośw. Wiatrołap
  {23, 26, RELAY_TRIGGER_LOW, -1, "Garderoba Wiatr"}, //61(12) Ośw. Garderoba przy wiatrołapie
  {24, 27, RELAY_TRIGGER_LOW, -1, "Garaż 1"},  //37(14) Ośw. Garaż Spot.4
  {25, 28, RELAY_TRIGGER_LOW, -1, "RELAY 25"},
  {26, 29, RELAY_TRIGGER_LOW, -1, "RELAY 26"},
  {27, 30, RELAY_TRIGGER_LOW, -1, "RELAY 27"},
  {28, 31, RELAY_TRIGGER_LOW, -1, "RELAY 28"},
  {29, 32, RELAY_TRIGGER_LOW, -1, "RELAY 29"},
  {30, 33, RELAY_TRIGGER_LOW, -1, "RELAY 30"},
  {31, 34, RELAY_TRIGGER_LOW, -1, "RELAY 31"},
  {32, 35, RELAY_TRIGGER_LOW, -1, "RELAY 32"}
